"""
Jyro code for the Scribbler robot from Parallax
(c) 2007-2018, Institute for Personal Robots in Education
http://roboteducation.org/
Distributed under a Shared Source License
"""
__VERSION__ = "$Revision: 1735 $"
...
from .graphics import Picture, rgb2yuv
...
class Scribbler(Robot):
    ...
    def open(self):
        import jyro.robot
        try:
            if self.serialPort == jyro.robot._robot.ser.portstr:
                jyro.robot._robot.ser.close()
